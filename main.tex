...
% Equal-contribution authors get a trailing \textsuperscript{*} via the
% `equalcontrib` annotation; pair with note = {* Equal contribution.}.
\renewcommand*{\mkbibnamefamily}[1]{%
  \ifitemannotation{highlight}{\textbf{#1}}{#1}%
  \ifitemannotation{equalcontrib}{\textsuperscript{*}}{}}
