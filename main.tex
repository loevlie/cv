...
\begin{itemize}
  ...
  \item \textbf{Systems:} built on-device object detection with 3D localization, monocular depth estimation, and 3D map generation from monocular drone imagery; deployed on flight hardware via TensorRT. Two in-person demos secured the next round of funding.
\end{itemize}
