...
\begin{itemize}
  ...
  \item Designed convolutional and transformer-based classification pipelines on 3D \acro{MRI}/\acro{CT} for early indicators of dementia and stroke; trained on Tufts \acro{HPC} with multi-\acro{GPU} distributed setups.
