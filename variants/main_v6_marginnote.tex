%---------------------------------------------------------------------------
% Dennis Johan Loevlie -- Academic CV (v6 — marginnote dates, Tufte CV)
% Aesthetic move: dates moved out of inline \hfill into the LEFT margin
% via \marginnote. Reads "academic monograph" instantly. Cost: ~1.5in
% extra left margin (we shift the asymmetric geometry to make room).
%---------------------------------------------------------------------------
...
% Asymmetric geometry: large left margin holds the date marginalia.
\usepackage[left=1.55in,right=0.6in,top=0.5in,bottom=0.55in,marginparwidth=1.0in,marginparsep=0.15in]{geometry}
...
% v6: marginnote for date marginalia. Reverse so notes go in left margin
% (read-side of the page, where the eye lands first).
\usepackage{marginnote}
\reversemarginpar
\renewcommand*{\marginfont}{\sansfam\scriptsize\color{meta}}
...
% v6 role: date moves into LEFT margin via \marginnote. The label fills
% the full text column. \filbreak still atomicizes role+sub+bullets.
\newcommand{\role}[2]{%
  \filbreak%
  \par\vspace{1pt}%
  \noindent\textbf{#1}\marginnote{#2}\par\nopagebreak}
