%---------------------------------------------------------------------------
% Dennis Johan Loevlie -- Academic CV (v5.2 — Libertinus Serif body)
% Body: Libertinus Serif (Linux Libertine fork, modern academic, real SC)
% Headers/dates: IBM Plex Sans
% URLs: IBM Plex Mono
% Engine: pdflatex (libertinus-type1 ships small caps)
%---------------------------------------------------------------------------
...
% --- Typography ----------------------------------------------------------
% Libertinus: load only the serif (we keep Plex Sans + Plex Mono).
% osf+p = old-style proportional figures by default.
\usepackage[serif,osf,p]{libertinus-type1}
...
% --- Section / subsection ------------------------------------------------
% v5.2: Libertinus ships real small caps. Serif SC for section heads.
...
% v5.2: Venue + acro use REAL small caps from Libertinus.
