%---------------------------------------------------------------------------
% Dennis Johan Loevlie -- Academic CV
% Typography pass v3:
%   - Body in IBM Plex Serif w/ proportional old-style figures
%   - Section headers in true small caps (real \textsc, letter-spaced)
%   - Sans only as a single restrained accent on date columns
%   - Hanging-indent publications, fancyhdr running head on pp.2+
%   - \frenchspacing, lining tabular figures only inside date columns
%---------------------------------------------------------------------------
...
% v3 variant: Bringhurst-correct measure (~75 chars/line) preserved via
% 0.85in side margins, but top/bottom pulled in to recover vertical space.
\usepackage[left=0.85in,right=0.85in,top=0.5in,bottom=0.55in]{geometry}
...
% v3 variant: Butterick lower bound for body leading is 120%; serif body
% needs ~1.10–1.15 to read comfortably at Bringhurst measure.
\linespread{1.10}
...
\usepackage{parskip}
% v3 has wider margins + looser leading; tighter parskip claws back the
% vertical space without losing baseline-grid consistency.
\setlength{\parskip}{0.15\baselineskip plus 0.05\baselineskip minus 0.05\baselineskip}
\usepackage{xspace}
...
\titlespacing*{\section}{0pt}{0.45\baselineskip plus 0.05\baselineskip minus 0.05\baselineskip}{0.15\baselineskip}

\titleformat{\subsection}
  {\footnotesize\itshape\color{meta}}
  {}{0em}{}
\titlespacing*{\subsection}{0pt}{0.2\baselineskip}{0pt}
