...
% --- Short/long toggle ---
% \shortversiontrue gives a 2-page recruiter cut (cuts AiThElite + chem
% publications subsection).  \shortversionfalse (or omitted) gives the
% full 3-page committee version.
\newif\ifshortversion
\shortversiontrue   % flip to false (or comment) for full version
...
% Older ChemE research positions cut from short version
\ifshortversion\else
...
% Older industry roles cut from short version
\ifshortversion\else
